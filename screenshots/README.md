...
All screenshots use the fictional Golden Client 2 household. They contain no
real client records, credentials, local paths, or proprietary planning-source
documents.
...
| `architectai_financial_snapshot.png` | Deterministic financial calculations and grounded plan basis |
| `architectai_action_plan.png` | Prioritized, actionable client-plan output |
