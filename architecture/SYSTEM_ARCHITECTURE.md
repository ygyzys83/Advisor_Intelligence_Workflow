...
flowchart LR
    subgraph LOCAL["Local / Private Processing"]
        ...
        subgraph AAI["ArchitectAI"]
            ...
            L["Govern and retrieve topic-specific CFP knowledge<br/>from Chroma vector store"]
...
- Knowledge sources are registered by authority, approved use, planning role,
  topic, and review date.
- Specialty knowledge is excluded by default and activated only by approved
...
| Specialty knowledge routing | Deterministic application logic | Prevents generated prose from activating specialized advice |
...
- Enforce source governance and activate specialty knowledge only when
  supported by approved client facts
